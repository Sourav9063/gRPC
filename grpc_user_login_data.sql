...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3410693104ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grpc_user_login_data&table=tbl_hashed_user_data">`grpc_user_login_data`.`tbl_hashed_user_data`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="267e3b61422b3f695460435d556d212c">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="grpc_user_login_data" targettable="tbl_hashed_user_data">
            ...
            Database
                            : <span>grpc_user_login_data</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `grpc_user_login_data`.`tbl_hashed_user_data` ( `email` VARCHAR(64) NOT NULL ,  `password` VARCHAR(64) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_hashed_user_data`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="grpc_user_login_data" targettable="tbl_hashed_user_data">
                            <div class="action_content">
